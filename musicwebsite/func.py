...
from models import PlayList, Song, NewUser, FreePlayList, FreeSong, UdpateFreePlayList, MobAppVersion
...
def insertFreePlaylistToPos(playList, pos):
	i = playList.pos
	#playListId = playList.id
	#print('i = ' + str(i))
	#print('pos = ' + str(pos))
	...
	#print('isUp = ' + str(isUp))
	try:
		p = FreePlayList.objects.get(pos = i)
	except:
		p = None
	while (i != pos) and (p != None):
		if isUp:
...
def insertFreeSongToPos(song, pos):
	i = song.pos
	playList_id = song.playList.id
	#print("i = " + str(i))
	#print("pos = " + str(pos))
	...
	#print("i = " + str(i))
	try:
		s = FreeSong.objects.filter(playList__id = playList_id).get(pos = i)
	except:
		s = None
	#print("s == " + str(s))
	while (i != pos) and (s != None):
...
def removeBlankSpaceInFreeList(pos, playList_id):
	pos += 1
	try:
		s = Song.objects.filter(playList__id = playList_id).get(pos = pos)
	except:
...
def saveFreeImg(id, title, img_name, img):
	path = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + title)
	if img_name.endswith(".jpg"):
		expansion = ".jpg"
	elif img_name.endswith(".jpeg"):
		expansion = ".jpeg"
...
def renameFreeImg(id, oldTitle, newTitle, expansion):
	oldPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + oldTitle + 'xxxhdpi.' + expansion)
	newPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + newTitle + 'xxxhdpi.' + expansion)
	os.rename(oldPath, newPath)

	oldPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + oldTitle + 'xxhdpi.' + expansion)
	newPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + newTitle + 'xxhdpi.' + expansion)
	os.rename(oldPath, newPath)

	oldPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + oldTitle + 'xhdpi.' + expansion)
	newPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + newTitle + 'xhdpi.' + expansion)
	os.rename(oldPath, newPath)

	oldPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + oldTitle + 'hdpi.' + expansion)
	newPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + newTitle + 'hdpi.' + expansion)
	os.rename(oldPath, newPath)

	oldPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + oldTitle + 'mdpi.' + expansion)
	newPath = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + newTitle + 'mdpi.' + expansion)
	os.rename(oldPath, newPath)


def deleteFreeImg(id, title, expansion):
	path = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + title + 'xxxhdpi.' + expansion)
	os.remove(path)

	path = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + title + 'xxhdpi.' + expansion)
	os.remove(path)

	path = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + title + 'xhdpi.' + expansion)
	os.remove(path)

	path = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + title + 'hdpi.' + expansion)
	os.remove(path)

	path = os.path.join(MEDIA_ROOT, "album_img/free_img/" + str(id) + '_' + title + 'mdpi.' + expansion)
	os.remove(path)